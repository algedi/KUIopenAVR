...
file systems on SD flash memory cards.  Experimental support for FAT12 can
be enabled by setting FAT12_SUPPORT non-zero in SdFat.h. Standard SD and
high capacity SDHC cards are supported.
...
An experimental formatter, SdFatFormatter.pde, is included in the
%SdFat/examples/SdFatFormatter directory.  This sketch attempts to
